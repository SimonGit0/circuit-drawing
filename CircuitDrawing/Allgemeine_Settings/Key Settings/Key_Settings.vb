Public Class Key_Settings
    ...
    Public ReadOnly keyCopyPNGToClipboard As ShortcutKey
    ...
    Private Sub New()
        ...
        keyCopyPNGToClipboard = New ShortcutKey(Keys.P, True)
        alleKeys.Add(keyCopyPNGToClipboard)
        ...
        alleKeys.Add(keyCopyEMFToClipboard)
    End Sub
